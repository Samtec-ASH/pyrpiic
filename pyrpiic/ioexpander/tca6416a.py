...
class TCA6416A:
    PORT0 = ['P01', 'P02', 'P03', 'P04', 'P05', 'P06', 'P07']
    PORT1 = ['P11', 'P12', 'P13', 'P14', 'P15', 'P16', 'P17']
    TCA6416A_BASE_INPUT = 0x00
    TCA6416A_PORT0_INPUT = 0x00
    TCA6416A_PORT1_INPUT = 0x01
    TCA6416A_BASE_POLARITY = 0x02
    TCA6416A_PORT0_POLARITY = 0x02
    TCA6416A_PORT1_POLARITY = 0x03
    TCA6416A_BASE_OUTPUT = 0x04
    TCA6416A_PORT0_OUTPUT = 0x04
    TCA6416A_PORT1_OUTPUT = 0x05
    ...
    def set_gpio_polarity(self, gpio: str, flipped: bool):
        ...
        port_index = self.get_port_index(gpio)
        gpio_bit = self.get_gpio_bit_position(gpio)
        self.set_register_bit(self.TCA6416A_BASE_OUTPUT + port_index, gpio_bit, flipped)
